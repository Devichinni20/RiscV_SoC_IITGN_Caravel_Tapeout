source -echo /home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/standaloneFlow/icc2_common_setup.tcl
source -echo /home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/standaloneFlow/icc2_dp_setup.tcl
...
#initialize_floorplan -control_type die -boundary {{0.0000 0.0000} {3588.0000 5188.0000}} -core_offset {300 300 300 300}
#initialize_floorplan -control_type die -honor_pad_limit -boundary {{0.0000 0.0000} {3588.0000 5188.0000}} -core_offset {300 300 300 300}
#initialize_floorplan -die_area {0 0 3588 5188} -core_area {300 300 3288 4888}
#initialize_floorplan -die_boundary {0 0 3588 5188} -core_boundary {300 300 3288 4888}

#initialize_floorplan -boundary {{0 0} {3588 5188}} -core_offset 300    
