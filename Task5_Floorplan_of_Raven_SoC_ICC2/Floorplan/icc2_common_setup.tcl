...
set REFERENCE_LIBRARY 		[list /home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/nangate_stdcell.lef /home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/sram_32_1024_freepdk45.lef]	;# Required; a list of reference libraries for the design library.
...
#set VERILOG_NETLIST_FILES      "/home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/pnrScripts/spi_slave.synth.v"
set VERILOG_NETLIST_FILES	"/home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/pnrScripts/raven_wrapper.synth.v"	;# Verilog netlist files;
					;# 	for DP: required
...
set TCL_PARASITIC_SETUP_FILE	"/home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/standaloneFlow/init_design.read_parasitic_tech_example.tcl"	;# Specify a Tcl script to read in your TLU+ files by using the read_parasitic_tech command;
					;# refer to the example in templates/init_design.read_parasitic_tech_example.tcl 

#set TCL_MCMM_SETUP_FILE         ""
set TCL_MCMM_SETUP_FILE		"/home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/standaloneFlow/init_design.mcmm_example.auto_expanded.tcl"	;# Specify a Tcl script to create your corners, modes, scenarios and load respective constraints;
...
set TECH_FILE 			"/home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/nangate.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
...
set TCL_TECH_SETUP_FILE		"/home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/standaloneFlow/init_design.tech_setup.tcl"
...
set LINK_LIBRARY		[list /home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/nangate_typical.db /home/cdmanasa/Floorplan_Task5/icc2_workshop_collaterals/sram_32_1024_freepdk45_TT_1p0V_25C_lib.db]	;# Specify .db files;
